    ...
    >
      {pullRequests ? (
        pullRequests.map(props => {
          const pullRequestNumber = props.number.toString();
          const conflicts =
            pullRequestConflicts && pullRequestNumber in pullRequestConflicts
              ? pullRequestConflicts[pullRequestNumber]
              : [];
          ...
          return (
            <PullRequestCard
              key={props.id}
              {...props}
              loadingConflicts={pullRequestConflicts === undefined}
